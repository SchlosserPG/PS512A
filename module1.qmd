...
### Comments
-   Another way to add text is to use comments. 
...
* Esentially, we add comments to our code to document our work and add notes to our self or to others.
```{r}
...
### String 
-   R can generally use single quotes or double quotes when marking text, or more formally a _string_. However, if you use a single quote to start, use a single quote to end. The same for double quotes - ensure the pairing is the same quote type.
